...
There are `r medicare-id` unique Medicare IDs
...
The results from the different treatment effect estimators are similar. The results using the nearest neighbour matching methods are the same using both inverse variance distance and Mahalanobis distance at 199.5281. The results using inverse propensity weight and regression are more different at 161.7769 and 187.2840 respectively.  
