...
knitr::kable(table_6_2, 
             ...
             format.args = list(big.mark=","), caption = "Average Price for Penalised and Non-Penalised Hospitals")
```
...
The results from the different treatment effect estimators are exactly the same at 199.5281.   
